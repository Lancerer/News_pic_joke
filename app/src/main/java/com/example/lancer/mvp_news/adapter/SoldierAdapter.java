...
public class SoldierAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    public List<SoldierBean.NewslistBean> pelist = null;
    Context mContext;
    BitmapUtils bitmapUtils;
    private static final int TYPE_ITEM = 0;  //普通Item View
    private static final int TYPE_FOOTER = 1;  //顶部FootView

    public SoldierAdapter(Context context, List<SoldierBean.NewslistBean> list) {
        pelist = list;
        mContext = context;
