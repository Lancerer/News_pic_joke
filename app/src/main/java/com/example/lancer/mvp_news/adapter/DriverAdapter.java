...
public class DriverAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener{
    ...
    public DriverAdapter(Context context, List<DriverBean.NewslistBean> list) {
        beanList = list;
        mContext = context;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemHolder) {
            ...
            String picUrl =beanList .get(position).getPicUrl();
            ...
            viewHolder.tvtime.setText(beanList.get(position).getCtime());
